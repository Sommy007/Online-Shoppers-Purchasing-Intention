...
*  The Random Forest model delivered the strongest performance, while Logistic Regression performed poorly. This clear disparity indicates that the relationships between the target variable and the predictors are predominantly nonlinear.
