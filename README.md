...
* RandomForest gave the best performance, Logistic regression performnance was poor showing that the relationship between the target and the predictors are mostly nonlinear.
RandomForest gave the best performance, Logistic regression performnance was poor showing that the relationship between the target and the predictors are mostly nonlinear.
